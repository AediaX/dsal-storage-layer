  ...
  const sections = [
    {
      ...
      description: "Intern progress, approvals & tracking",
    ...
    { 
      ...
      description: "Admins, mentors & student roles",
      path: "/admin/users",
      icon: <PeopleIcon />,
    ...
    },
    {
      ...
      path: "/admin/contact-control",
      icon: <ContactMailIcon />,
      color: theme.palette.error.main,
    },
    {
      title: "Service Consultancy",
      description: "Manage service consultancy requests and projects",
      path: "/admin/service-consultancy",
      icon: <AssignmentIcon />,
  ...
  return (
    <>
      ...
      <Box sx={{ maxWidth: 1200, mx: "auto", px: 3, mt: 6, pb: 10 }}>
        ...
        >
          Centralized control for all platform operations
        </Typography>
