  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column" }}>
        ...
        <DialogContent>
          <Alert severity="error" sx={{ mb: 2 }}>
            <Typography variant="body1" fontWeight={600}>
              ⚠️ Critical Action - Admin Account Deletion!
            </Typography>
          </Alert>
          
          <Typography variant="body2" color="textSecondary" paragraph>
            You are about to permanently delete your administrator account. This will remove:
          </Typography>
          
          <Box component="ul" sx={{ pl: 2, color: theme.palette.text.secondary }}>
            <li><Typography variant="body2">Admin profile and privileges</Typography></li>
            <li><Typography variant="body2">All administrative data</Typography></li>
            <li><Typography variant="body2">Authentication credentials</Typography></li>
            <li><Typography variant="body2">User management access</Typography></li>
            <li><Typography variant="body2">Internship application data</Typography></li>
          </Box>
      ...
      >
        ...
        <DialogContent>
          <Typography variant="body2" color="textSecondary" paragraph>
            For security purposes, please enter your password to confirm admin account deletion:
          </Typography>
